...
def tank(x,y, turPos):
    ...
    pygame.draw.circle(gameDisplay, green, (x,y),int(tankHeight/2))
    pygame.draw.rect(gameDisplay, green, (x-tankHeight, y, tankWidth, tankHeight))

    pygame.draw.line(gameDisplay,green, (x,y), possibleTurrets[turPos], turretWidth)
...
def game_controls():
    ...
    while gcont:
        ...
        message_to_screen("Tank Controls", green, -100, size="large")
        message_to_screen("Fire: Spacebar", black, -30)
        message_to_screen("Move turret: Up and Down", black, 10)
        message_to_screen("Move tank: Left and Right", black, 50)
        message_to_screen("Increase fire power: D",black,90)
        message_to_screen("Decrease fire power: A",black,130)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("One objective:", black, -30)
        message_to_screen("Kill your enemy!", red, 50)
...
def game_over():
    ...
    while game_over:
        ...
        message_to_screen("YOU LET THE ENEMY GET", black, -30)
        message_to_screen("THE BEST OF YOU", red, 50, size="large")
        

        button("Try again", 150,500,150,50, green, light_green, action="play")
        button("Controls", 350,500,100,50, yellow, light_yellow, action="controls")
        button("Quit", 550,500,100,50, red, light_red, action="quit")
...
def you_win():
    ...
    while win:
        ...
        gameDisplay.fill(white)
        message_to_screen("WELL DONE SOLDIER!", green, -100, size="large")
        message_to_screen("YOU LET THOSE MOFOS", black, -30)
        message_to_screen("TASTE AMERICA", red, 50, size="large")
        

        button("Go again!", 150,500,150,50, green, light_green, action="play")
        button("Controls", 350,500,100,50, yellow, light_yellow, action="controls")
        button("Quit", 550,500,100,50, red, light_red, action="quit")
